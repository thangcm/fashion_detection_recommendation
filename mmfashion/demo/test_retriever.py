...
import argparse
import sys
sys.path.insert(0, './mmfashion')

import torch
from mmcv import Config
from mmcv.runner import load_checkpoint

from mmfashion.mmfashion.core import ClothesRetriever
from mmfashion.mmfashion.datasets import build_dataloader, build_dataset
from mmfashion.mmfashion.models import build_retriever
...
def parse_args():
    ...
    parser.add_argument(
        ...
        # default='mmfashion/configs/retriever_consumer_to_shop/roi_retriever_vgg.py')
        # default='mmfashion/configs/retriever_in_shop/global_retriever_resnet.py')
    parser.add_argument(
        '--checkpoint',
        type=str,
        default='mmfashion/checkpoint/Retrieve/vgg/global/epoch_100.pth',
        # default='mmfashion/checkpoint/Retrieve/vgg/global/epoch_100_customer.pth',
        # default='mmfashion/checkpoint/Retrieve/vgg/global/latest.pth',
